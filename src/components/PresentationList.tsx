...
export function PresentationList({ onOpen }: Props) {
  ...
  const isGuest = user?.role === 'anonymous';
  ...
  return (
    <div class="pres-list-page">
      ...
      {isGuest && (
        <div class="guest-notice" role="note">
          <span>👁 You're browsing as a guest — you can view public presentations but cannot create new ones.</span>
        </div>
      )}
